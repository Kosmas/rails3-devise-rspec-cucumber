...
Rails 4.x example application shows how to use "Devise":http://github.com/plataformatec/devise with "RSpec":http://rspec.info/ and "Cucumber":http://cukes.info/.
...
<pre>
$ git clone git://github.com/RailsApps/rails4-devise-rspec-cucumber.git
</pre>
...
<pre>
$ rails new rails4-devise-rspec-cucumber -m https://raw.github.com/RailsApps/rails-composer/master/composer.rb -T
</pre>
...
This creates a new Rails app named @rails4-devise-rspec-cucumber@ on your computer. You can use a different name if you wish.
...
question  Install an example application?
      ...
      5)  rails4-devise-rspec-cucumber
      6)  rails3-mongoid-devise
      7)  rails3-mongoid-omniauth
      8)  rails3-subdomains
</pre>

Choose *rails4-devise-rspec-cucumber*. The Rails Composer tool may give you other options (other choices may have been added since these notes were written).
...
Problems? Check the "issues":https://github.com/RailsApps/rails4-devise-rspec-cucumber/issues.
...
Send the author a message, create an "issue":http://github.com/RailsApps/rails4-devise-rspec-cucumber/issues, or fork the project and submit a pull request.
